<div class="panel panel-default">
		  <div class="panel-heading">SER - Distriuição <span class="badge">{{count($celulaDistribuicaoCustom)}}</span>	</div>
			  <div class="panel-body">
				<div class="table-responsive">
					<table class="table table-condensed table-striped">
						...
						@if(count($celulaDistribuicaoCustom) > 0)
							<script>
								 notificarSlaIni = true;
							</script>
						@endif
						@foreach($celulaDistribuicaoCustom as $sla)
