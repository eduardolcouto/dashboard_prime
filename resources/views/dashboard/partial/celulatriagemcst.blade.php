<div class="panel panel-default">
		  <div class="panel-heading">SER - Triagem <span class="badge">{{count($celulaTriagemCustom)}}</span>	</div>
			  <div class="panel-body">
				<div class="table-responsive">
					<table class="table table-condensed table-striped">
						...
						@if(count($celulaTriagemCustom) > 0)
							<script>
								 notificarSlaIni = true;
							</script>
						@endif
						@foreach($celulaTriagemCustom as $sla)
