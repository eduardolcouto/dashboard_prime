<div class="panel panel-default">
		  <div class="panel-heading">Celula2 - Distribuição <span class="badge">{{count($celula2Distribuicao)}}</span></div>
			  <div class="panel-body">
				<div class="table-responsive">
					<table class="table table-condensed table-striped">
						...
						@if(count($celula2Distribuicao) > 0)
							<script>
								 notificarSlaCont = true;
							</script>
						@endif
						@foreach($celula2Distribuicao as $sla)
