<div class="panel panel-default">
		  <div class="panel-heading">SER - Luciana Devera <span class="badge">{{count($celulaCstLucianaDevera)}}</span>	</div>
			  <div class="panel-body">
				<div class="table-responsive">
					<table class="table table-condensed table-striped">
						...
						@if(count($celulaCstLucianaDevera) > 0)
							<script>
								 notificarSlaIni = true;
							</script>
						@endif
						@foreach($celulaCstLucianaDevera as $sla)
