<div class="panel panel-default">
		  <div class="panel-heading">SER - Emerson Casado <span class="badge">{{count($celulaCstEmersonCasado)}}</span>	</div>
			  <div class="panel-body">
				<div class="table-responsive">
					<table class="table table-condensed table-striped">
						...
						@if(count($celulaCstEmersonCasado) > 0)
							<script>
								 notificarSlaIni = true;
							</script>
						@endif
						@foreach($celulaCstEmersonCasado as $sla)
